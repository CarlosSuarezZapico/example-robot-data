...
class Bravo7NoEndEffectorV2Loader(RobotLoader):
    path = "bravo7_description"
    urdf_filename = "bravo7_no_ee_v2.urdf"
    urdf_subpath = "urdf"
    srdf_filename = "bravo7_no_ee_v2.srdf"
    ref_posture = "standing"
    free_flyer = False

class Bravo7IdentificationLoader(RobotLoader):
    path = "bravo7_description"
    urdf_filename = "bravo7_identification.urdf"
    urdf_subpath = "urdf"
    srdf_filename = "bravo7_identification.srdf"
    ref_posture = "standing"
    free_flyer = False
